...
export default function Home() {
    ...
    useEffect(() => {
        ...
        workApi.getWorksDetailsById(new WorksIdRequest({
            ...
            setName(req.worksName);
            setContent(req.content);
            setHeaderImageURL(req.headerImageURL)
            setFileId(req.fileId);
            setImageUrlList(req.imageUrlList);
            //文件信息更新
    ...
    //提交按钮
    const addWorks = () => {
        workApi.updateWorks(new UpdateWorksRequest({
            name: name,
            worksId:workId,
            teamId: teamId,
